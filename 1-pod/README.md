...
![스크린샷 2021-10-27 오전 3.38.34.png](./images/2021-10-27_3.38.34.png)
...
![스크린샷 2021-10-30 오후 3.52.02.png](./images/2021-10-30_3.52.02.png)
...
- 요청 횟수를 redis에 저장하는 웹앱
    - 한 파드 안에 counter앱과 redis 컨테이너가 있으므로, counter 앱은 redis를 localhost로 접근할 수 있다.
        ...
        ![스크린샷 2021-10-27 오전 8.48.05.png](./images/2021-10-27_8.48.05.png)
